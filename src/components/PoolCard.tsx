...
export default function PoolCard({ pair, onViewDetails }: PoolCardProps) {
  ...
  return (
    <Card className="group relative min-w-[400px] overflow-hidden transition-all duration-300 hover:shadow-lg border border-border/50 hover:border-border bg-card">
